...
hl.define_submap("tools", "reset", function()
    hl.bind("a", hl.dsp.exec_cmd('hyprctl activewindow -j | wl-copy'), { desc = "active window info" })
    ...
    hl.bind("f", ToggleUrgentFocus,                                      { desc = "toggle auto focus" })
    hl.bind("g", hl.dsp.exec_cmd(scripts .. "/tools/uuidgen.sh"),         { desc = "generate uuid" })
    hl.bind("i", hl.dsp.exec_cmd("iptvnator"),                               { desc = "iptv" })
    hl.bind("k", hl.dsp.exec_cmd('ghostty -e ncdu --group-directories-first'),{ desc = "disk usage" })
